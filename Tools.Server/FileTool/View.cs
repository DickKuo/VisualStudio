...
namespace CommTool.Service {
    public class DServiceContainer : IServiceContainer, IServiceProvider {
        ...
        private class Default {
            ...
            public const string ErrorServiceExists = "ErrorServiceExists";
        }
        ...
        public void AddService(System.Type serviceType, ServiceCreatorCallback callback, bool promote) {
            ...
            if (serviceType == null) {
                throw new System.ArgumentNullException(Default.serviceType);
            }
            if (callback == null) {
            ...
            if (this.Services.ContainsKey(serviceType)) {
                ...
                throw new System.ArgumentException(Default.ErrorServiceExists, Default.serviceType);
            }
