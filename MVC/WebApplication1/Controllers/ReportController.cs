...
namespace WebApplication1.Controllers
{
    public class ReportController : BaseLoginController
    {
        ...
        private void MachResult(DataTable dt, ReportViewModels.TradeRecordReportModel TradeModel) {
            ...
            TradeModel.Permission = Info.Customer.Role.Permission;
            ...
            if (dt != null && dt.Rows.Count > 0) {
                foreach (DataRow dr in dt.Rows) {                     
                    ...
                    _TradeRecord.OP = dr[Default.OP].ToString() == Default.Call ? Resources.ReportResource.Label_Call : Resources.ReportResource.Label_Put;
