...
namespace System.Web.Mvc.Html
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        {
            List<ScriptVarTag> scriptList = htmlHelper.ViewContext.HttpContext.Items["RenderJavaScriptVar"] as List<ScriptVarTag>;
            ...
            else
            {
                ...
                scriptList.Add(_ScriptVarTag);
                htmlHelper.ViewContext.HttpContext.Items.Add("RenderJavaScriptVar", scriptList);
            }
        }
        ...
        public static void AddJavaScript(this HtmlHelper htmlHelper, string scriptURL)
        {
            ...
            else
            {
                ...
                scriptList.Add(scriptURL);
                htmlHelper.ViewContext.HttpContext.Items.Add("RenderJavaScript", scriptList);
            }
        }
        ...
        {
            List<string> styleList = htmlHelper.ViewContext.HttpContext.Items["RenderStyle"] as List<string>;
            if (styleList != null)
            {
            ...
            else
            {
                ...
                styleList.Add(styleURL);
                htmlHelper.ViewContext.HttpContext.Items.Add("RenderStyle", styleList);
            }
        }
