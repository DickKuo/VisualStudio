...
{
    //服務容器。
    public class ServiceContainer : IServiceContainer, System.IServiceProvider
    {
        ...
        {
            ServiceContainer.TRACESERVICE = new TraceSwitch("TRACESERVICE", "ServiceProvider: Trace service provider requests.");
        }
